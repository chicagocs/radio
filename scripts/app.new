document.addEventListener('DOMContentLoaded', () => {
    ...
    const countdownContainer = document.getElementById('countdownContainer'); // Nuevo elemento
    ...
    // ==========================================================================
    //    FUNCIONES PARA GESTIONAR EL ESTADO DE LA INTERFAZ
    // ==========================================================================
    
    // Función para mostrar la imagen de fondo en el contenedor de detalles
    function displayIdleCover() {
        countdownContainer.style.backgroundImage = 'url(/images/radiomax-social-card-1200x630.jpg)';
        countdownContainer.style.backgroundSize = 'cover';
        countdownContainer.style.backgroundPosition = 'center';
        countdownContainer.style.backgroundRepeat = 'no-repeat';
    }

    // Función principal para establecer el estado visual inactivo
    ...
    // Función para el estado inicial al cargar la página
    function setInitialState() {
        setIdleState(); // Establece el fondo y los placeholders
        songTitle.textContent = 'A sonar'; // Mantiene el texto inicial
        songArtist.textContent = '';
        songAlbum.textContent = '';
        updateShareButtonVisibility();
    }

    // Función para el estado al detener la reproducción
    function stopSongInfoUpdates() {
        if (updateInterval) { clearInterval(updateInterval); updateInterval = null; }
        
        setIdleState(); // Establece el estado inactivo
        
        // Limpia completamente la información de la canción
    ...
    // Al final del evento DOMContentLoaded, establece el estado inicial
    setInitialState();
});
