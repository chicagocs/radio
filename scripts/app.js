document.addEventListener('DOMContentLoaded', () => {
    ...
    class CustomSelect {
        ...
        createCustomOption(option) {
            ...
            let description = '';
            let tags = [];
            let promotions = []; // NUEVO: Variable para las promociones
            ...
            if (station) {
                ...
                tags = station.tags || [];
                promotions = station.promotions || []; // NUEVO: Obtener promociones del objeto station
            }
            ...
            if (promotions && promotions.length > 0) {
                ...
                promotions.forEach(promo => {
                    ...
                    promoLink.target = '_blank'; // Abrir en una nueva pestaña
                    promoLink.rel = 'noopener noreferrer'; // Seguridad
                    
                    promotionsContainer.appendChild(promoLink);
                });

                stationInfo.appendChild(promotionsContainer);
            }
            // ===========================================
