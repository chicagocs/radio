document.addEventListener('DOMContentLoaded', () => {
    ...
    // ==========================================================================
    //    FUNCIÓN PARA MOSTRAR EL ESTADO INACTIVO CON PORTADA
    // ==========================================================================
    function displayIdleCover() {
        // Establece la imagen de fondo para el contenedor de la portada del álbum
        albumCover.style.backgroundImage = 'url(/images/radiomax-social-card-1200x630.jpg)';
        ...
        // Limpia cualquier contenido previo (como el placeholder "Portada")
        albumCover.innerHTML = '';
    }
    ...
    function stopSongInfoUpdates() {
        ...
        // Llama a tu nueva función para mostrar la portada
        displayIdleCover(); 
        
        resetAlbumDetails();
        currentTrackInfo = null;
        
        // Limpia el título para que no se muestre texto sobre la imagen
    ...
    // Al final del evento DOMContentLoaded, establece el estado inicial inactivo
    stopSongInfoUpdates();
});
