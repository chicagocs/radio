...
document.addEventListener('DOMContentLoaded', () => {
    ...
    // NUEVO: Elemento para el botón de filtro de favoritos
    ...
    // NUEVO: Variable para el estado del filtro de favoritos
    ...
    // ==========================================================================
       // NUEVO: LÓGICA PARA FILTRO DE FAVORITOS
       // ==========================================================================
    function updateFavoritesToggleButtonUI() {
        if (!toggleFavoritesBtn) return;

        if (isFilteringFavorites) {
            toggleFavoritesBtn.innerHTML = '<span class="favorite-icon">★</span><span class="btn-text">VER TODAS</span>';
            toggleFavoritesBtn.classList.add('active');
        } else {
            toggleFavoritesBtn.innerHTML = '<span class="favorite-icon">☆</span><span class="btn-text">FAVORITOS</span>';
        ...
        allCustomOptions.forEach(option => {
            ...
            if (isFilteringFavorites) {
                if (favoriteIds.includes(stationId)) {
                    option.style.display = 'block'; // Mostrar
                } else {
    ...
    class CustomSelect {
        ...
        createCustomOption(option) {
            ...
            // Crear contenedor principal para la info y el botón
            const stationInfoContainer = document.createElement('div');
            stationInfoContainer.className = 'station-info';

            // Contenedor para los detalles de la estación (texto)
