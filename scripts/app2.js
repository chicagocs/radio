...
function updateTooltipPosition() {
    ...
    // IMPORTANTE: No sobreescribimos referenceEl.textContent para permitir que se mantenga 'N/A'
    if (!referenceEl || !tooltipEl || currentCredits === '') {
        if(tooltipEl) tooltipEl.style.opacity = '0';
        if(referenceEl) {
            // referenceEl.textContent = '--'; // ELIMINADO para permitir N/A
                    ...
                    if (data.recordings && data.recordings.length > 0) {
                        ...
                        if (creditsElement && r.relations) {
                            ...
                            if (creditHtml) {
                                ...
                                if (fetchId !== currentSongFetchId) return;
                                // FIX: Mostrar N/A y limpiar tooltip para evitar datos de la canción anterior
                ...
                if (creditsRes.ok) {
                    ...
                    if (creditsElement && creditsData.relations) {
                        ...
                        if (creditHtml) {
                            ...
                            if (fetchId !== currentSongFetchId) return;
                            // FIX: Mostrar N/A y limpiar tooltip
                            creditsElement.textContent = 'N/A';
                            currentCredits = "";
